...
## 📖 Full Documentation & Troubleshooting Log

- Detailed Operation & Setup: [`docs/user_manual.md`](./docs/user_manual.md)
- Reverse Engineering & Failures Log: [`docs/findings.md`](./docs/findings.md)
